...
public class Util {
    ...
    public static void opcoesErro(Context context, String resposta) {
        ...
        if (resposta.contains("least 6 characters")) {
            Toast.makeText(context, "Digite uma senha com no mínimo 6 caracteres", Toast.LENGTH_LONG).show();
            ...
            Toast.makeText(context, "E-mail ainda não cadastrado", Toast.LENGTH_LONG).show();
        } else {
